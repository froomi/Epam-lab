...
public class DriverPropertiesFileReader {
    ...
    private static DriverPropertiesFileReader instance;

    public static DriverPropertiesFileReader getInstance() {

        if(instance == null){
            instance = new DriverPropertiesFileReader();
        }
        return instance;
    }


    private DriverPropertiesFileReader() {
